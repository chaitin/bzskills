...
This project is based on the source repository [vercel-labs/skills](https://github.com/vercel-labs/skills).
...
- Skills Hub: configure with `SKILLS_HUB_URL` when using a non-default Hub
